    ...
    <div className="min-h-screen bg-neutral-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-neutral-600">Welcome back, {artisan.name}</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card">
            <div className="text-sm text-neutral-600 mb-1">Active Orders</div>
            <div className="text-3xl font-bold text-success">{stats.activeOrders}</div>
          </div>
          <div className="card">
            <div className="text-sm text-neutral-600 mb-1">Pending Quotes</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <Link href="/products/new" className="card hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm text-neutral-600">Add a new product to your collection</p>
          </Link>
          <Link href="/custom-orders?filter=pending" className="card hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm text-neutral-600">Respond to custom order requests</p>
          </Link>
          <Link href="/profile" className="card hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm text-neutral-600">Edit your studio information</p>
          </Link>
        </div>
      </main>
    </div>
